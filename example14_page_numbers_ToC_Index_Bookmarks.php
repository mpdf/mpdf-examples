...
?>
	...
	<p>Maecenas arcu justo, malesuada
		...
		nisl et lectus. Sed lacinia, lectus vitae dictum sodales, elit ipsum ultrices orci, non euismod arcu diam non
		<indexentry content="metus"/>
		<i>metus</i>.
		Cum
		...
		<indexentry content="adipiscing"/>
		<i>adipiscing</i> id, mollis
		sed, posuere et, urna. Quisque ut leo. Aliquam interdum hendrerit tortor. Vestibulum elit. Vestibulum et arcu at
		diam
		<indexentry content="mattis"/>
	...
	<p>Maecenas arcu justo, malesuada
		...
		congue. Sed erat est, interdum nec, elementum eleifend, pretium at, nibh. Praesent massa diam, adipiscing id,
		<indexentry content="mollis"/>
		<i>mollis</i>
		sed, posuere et, urna. Quisque ut leo. Aliquam interdum hendrerit tortor. Vestibulum elit. Vestibulum et arcu at
		<indexentry content="diam"/>
	...
	<p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Proin vel sem at
		odio
		varius pretium.
		<indexentry content="Maecenas"/>
		...
		<indexentry content="Vestibulum"/>
		<i>Vestibulum</i> interdum luctus sapien. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla
		sit amet
	...
	<p>Nulla felis erat,
		...
		<indexentry content="neque"/>
		<i>neque</i> metus pellentesque risus, at eleifend lacus sapien et risus. Phasellus metus. Phasellus feugiat,
		<indexentry content="lectus"/>
		<i>lectus</i> ac
	...
	<p>Maecenas arcu justo, malesuada
		eu, dapibus ac, adipiscing vitae, turpis. Fusce mollis. Aliquam egestas. In purus dolor, facilisis at, fermentum
		nec,
		molestie et, metus. Vestibulum feugiat, orci at
		<indexentry content="imperdiet"/>
	...
	<p>Pellentesque habitant
		...
		non nunc. Maecenas fringilla. Curabitur libero. In dui massa, malesuada sit amet, hendrerit vitae, viverra nec,
		tortor.
		Donec varius. Ut ut dolor et tellus adipiscing adipiscing.
	</p>
	...
	<p>Maecenas arcu justo, malesuada
		...
		molestie et,
		<indexentry content="metus"/>
		<i>metus</i>. Vestibulum feugiat, orci at imperdiet tincidunt, mauris erat facilisis urna, sagittis ultricies
		dui
	...
	<p>Maecenas arcu justo, malesuada
		...
		<indexentry content="euismod"/>
		<i>euismod</i> arcu diam non metus.
		Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. In suscipit turpis vitae
		odio.
		Integer convallis dui at metus. Fusce magna. Sed sed lectus vitae
		<indexentry content="enim"/>
	...
	<p>Pellentesque habitant
		...
		non
		<indexentry content="nunc"/>
		<i>nunc</i>. Maecenas fringilla. Curabitur libero. In dui massa, malesuada sit amet, hendrerit vitae, viverra
		nec, tortor.
		<indexentry content="Donec"/>
	...
	<p>Proin aliquet
		...
		<i>mauris</i> nonummy
		<indexentry content="tincidunt"/>
		<i>tincidunt</i>. Donec imperdiet. Vestibulum sem sem, lacinia vel, molestie et, laoreet eget, urna. Curabitur
	...
	<p>Nulla felis
		...
		<indexentry content="pede"/>
		<i>pede</i>, auctor ac, suscipit
		quis, malesuada sed, nulla. Integer sit amet odio sit amet lectus luctus euismod. Donec et nulla. Sed quis orci.
	</p>
	...
	<p>Pellentesque habitant morbi tristique senectus et
		...
		Vestibulum
		<indexentry content="interdum"/>
		<i>interdum</i> luctus sapien. Quisque viverra. Etiam id libero at magna pellentesque aliquet. Nulla sit amet
		ipsum id enim tempus
		<indexentry content="dictum"/>
		<i>dictum</i>.
		<indexentry content="Maecenas"/>
